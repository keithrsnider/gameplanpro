...
// @ts-ignore
import { createAuthUserResponseFromDiscriminatorValue, serializeAuthUserResponse, serializeLoginRequest, type AuthUserResponse, type LoginRequest } from '../../../models/index.js';
// @ts-ignore
...
export interface LoginRequestBuilder extends BaseRequestBuilder<LoginRequestBuilder> {
     ...
     */
     post(body: LoginRequest, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<AuthUserResponse | undefined>;
    /**
     * @param body The request body
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
